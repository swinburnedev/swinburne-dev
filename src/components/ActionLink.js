...
export default class ActionLink extends React.Component {
    render() {
        ...
        return (
            <Link className={classNames({'button': _.get(action, 'style', null) === 'button', 'button-icon': _.get(action, 'style', null) === 'icon'})} href={withPrefix(_.get(action, 'url', null))} {...(_.get(action, 'new_window', null) ? ({target: '_blank', rel: 'noopener'}) : null)}>
